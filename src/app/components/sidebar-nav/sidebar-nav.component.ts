...
export class SidebarNavComponent implements OnInit {
    ...
    this.pages = [
      {
        ...
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="${this.iconSize}" height="${this.iconSize}" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
    ...
    this.buttons = [
      {
        ...
        title: "Settings",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="${this.iconSize}" height="${this.iconSize}" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
      ...
      },
      {
        ...
        title: "Sign Out",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="${this.iconSize}" height="${this.iconSize}" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
  ...
  ngAfterViewInit() {
    ...
    buttons.forEach((button, index) => {
      ...
      // This might be useful in the future, but for now...
      // if (this.buttons[index].hasOwnProperty("attributes")) {
      //   this.buttons[index].attributes.forEach((a: Array<Array<string>>) => {
      //     button.nativeElement.setAttribute(a[0], a[1]);
      //   });
      // }
    });
  }

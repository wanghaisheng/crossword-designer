...
describe("PuzzleService", () => {
  ...
  beforeEach(() => {
    ...
    firebaseServiceSpy.getDoc.and.returnValue(of(TestPuzzle));
  ...
  describe("loadPuzzle", () => {
    it("should return true number squares when successful", () => {
      service.loadPuzzle(testPuzzleId).subscribe((result: boolean) => {
    ...
    it("should return false when id equals current puzzle id", () => {
      service
        .loadPuzzle(testPuzzleId)
        .pipe(switchMap(() => service.loadPuzzle(testPuzzleId)))
        .subscribe((result) => {
  ...
  describe("savePuzzle", () => {
    it("should return true when successful", () => {
      service
        .loadPuzzle(testPuzzleId)
        .pipe(switchMap(() => service.savePuzzle()))
        .subscribe(() => {
          expect(firebaseServiceSpy.setDoc).toHaveBeenCalled();
        });
    });
  ...
  describe("clearPuzzle", () => {
    beforeEach(() => {
      service.loadPuzzle(testPuzzleId);
    });
